              ...
              <div className="course-details__content">
                ...
                <div className="course-details__top">
                  <div className="course-details__top-left">
                    <h2 className="course-details__title">Skateboarding</h2>
                  ...
                  >
                    {activeTab === 0 && (
                      <p className="course-details__tab-text">
                        Learn how to skateboard and grasp the basics of pushing,
                        turning and learning tricks. Skateboard classes are
                        mainly conducted at skate parks across the UK and by
                        skateboard schools (who run groups at skateparks or at
                        suitable facilities). You can book group lessons,
                        individual tuition or specific lessons types (girls only
                        lessons, adult lessons, under 8’s and much more). We
                        recommend that you ask that the instructors are DBS
                        checked, are first aid trained, have a safeguarding
                        certification and have the Skateboard GB Level 1
